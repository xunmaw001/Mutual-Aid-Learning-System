<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所教班级" prop="suojiaobanji">
        ...
        <div v-else>
          <el-form-item class="input" label="所教班级" prop="suojiaobanji">
	      <el-input v-model="ruleForm.suojiaobanji"
                placeholder="所教班级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
