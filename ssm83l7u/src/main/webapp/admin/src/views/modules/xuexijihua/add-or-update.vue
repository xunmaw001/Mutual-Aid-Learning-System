<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="计划目标" prop="jihuamubiao">
          <el-input v-model="ruleForm.jihuamubiao" 
              placeholder="计划目标" clearable  :readonly="ro.jihuamubiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="计划目标" prop="jihuamubiao">
              <el-input v-model="ruleForm.jihuamubiao" 
                placeholder="计划目标" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="学习安排" prop="xuexianpai">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xuexianpai" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuexianpai" label="学习安排" prop="xuexianpai">
                    <span v-html="ruleForm.xuexianpai"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    kechengmingchengChange () {
      this.$http({
        url: `follow/kechengxinxi/kechengmingcheng?columnValue=`+ this.ruleForm.kechengmingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.xuexianpai = this.ruleForm.xuexianpai.replace(reg,'../../../ssm83l7u/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
